...
class P2PKHBurn {
    static getLockScript() {
        const { JZ, CHKSIG, BURN } = Script_1.Script.Opcode;
        return buffer_1.Buffer.from([CHKSIG, JZ, 0xff, BURN]);
    }
    static getLockScriptHash() {
        return new codechain_primitives_1.H160("8cf03a38366586bfe66d8ada3c3b355de3273b86");
    }
    constructor(params) {
