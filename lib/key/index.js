...
var Key = /** @class */ (function () {
     ...
     * @param params.passphrase The passphrase for the given input.
     */
    Key.prototype.signTransactionInputWithOrder = function (tx, index, order, params) {
        if (params === void 0) { params = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var input, _a, lockScriptHash, parameters, publicKeyHash, _b, keyStore, passphrase, _c, p2pkh, _d, _e;
